...
public class EmeraldEXConstants {
    ...
    public static final int bsHPOffset = 0, bsAttackOffset = 1, bsDefenseOffset = 2, bsSpeedOffset = 3,
            ...
            bsCatchRateOffset = 8, bsCommonHeldItemOffset = 14, bsRareHeldItemOffset = 16, bsGenderRatioOffset = 18,
            bsGrowthCurveOffset = 21, bsAbility1Offset = 24, bsAbility2Offset = 26, bsAbility3Offset = 28;
    ...
    public static final int grassSlots = 6, surfingSlots = 5, rockSmashSlots = 5, fishingSlots = 10;
    ...
    public static final int waterStoneIndex = 105;

    public static final int highestAbilityIndex = 267;
    
    public static final int placeholderMoveEffectIndex = 209;
